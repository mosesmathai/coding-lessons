...
export default function Home() {
  ...
  return (
    ...
    <div>
      ...
      <p className=" mb-4">
        You can get our business system for <span className="text-green-500">$10,000</span>. It has a lifetime warranty. Downpayment is $1,000. The system has a Yearly maintenance cost of $100.
      </p>
      <p className=" mb-4">
